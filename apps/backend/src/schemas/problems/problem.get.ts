...
export const GetProblemBySlug: FastifySchema = {
  description: "Get a problem by its slug",
  tags: ["Problems"],
  summary: "get a problem by its slug",
  params: {
    type: 'object',
    required: ["slug"],
    properties: {
      slug: { type: 'string', description: 'slug of the problem' }
    }
  },
  response: {
    200: createResponseSchema(ProblemSchema),
