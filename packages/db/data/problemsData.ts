import { Language, Level, Topic } from '../generated/prisma/'
...
export const data: Data[] = [
        ...
        driverCodes: [
            {
                ...
                afterCode:
                    '\n\nint main() {\n    string line;\n    getline(cin, line);\n    vector<int> nums;\n    line = line.substr(1, line.length() - 2);\n    stringstream ss(line);\n    string num;\n    while (getline(ss, num, \',\')) {\n        nums.push_back(stoi(num));\n    }\n    \n    int target;\n    cin >> target;\n    \n    Solution sol;\n    vector<int> result = sol.twoSum(nums, target);\n    cout << "~";    cout << "[" << result[0] << "," << result[1] << "]" << endl;\n    return 0;\n}',
            },
            {
                language: 'C',
                beforeCode: '#include <stdio.h>\n#include <stdlib.h>\n\n',
                placeHolderCode:
            ...
            },
            {
                ...
                placeHolderCode: 'var twoSum = function(nums, target) {\n\n};',
                afterCode:
                    "\n\nlet input = [];\nrl.on('line', (line) => {\n    input.push(line.trim());\n    if (input.length === 2) {\n        const nums = JSON.parse(input[0]);\n        const target = parseInt(input[1]);\n      console.log('~');        console.log(JSON.stringify(twoSum(nums, target)));\n        rl.close();\n    }\n});",
            },
            {
                language: 'PYTHON',
                beforeCode: 'from typing import List\nimport sys\nimport json\n\n',
                placeHolderCode:
    ...
    },
    {
        ...
        driverCodes: [
            {
                language: 'CPP',
                beforeCode: '#include <string>\n#include <iostream>\nusing namespace std;\n\n',
                placeHolderCode:
                    'class Solution {\npublic:\n    bool isValid(string s) {\n\n    }\n};',
                afterCode:
                    '\n\nint main() {\n    string s;\n    cin >> s;\n    Solution sol;\n    bool isVal = sol.isValid(s);    cout << "~";    cout << (isVal ? "true" : "false") << endl;\n    return 0;\n}',
            },
            {
                language: 'C',
                beforeCode: '#include <stdio.h>\n#include <stdbool.h>\n#include <string.h>\n\n',
                placeHolderCode: 'bool isValid(char* s) {\n\n}',
                afterCode:
                    '\n\nint main() {\n    char s[10001];\n    scanf("%s", s);\n    bool isVal = isValid(s);    printf("~");    printf("%s\\n", isVal ? "true" : "false");\n    return 0;\n}',
            },
            {
                language: 'JS',
                beforeCode:
                    "const readline = require('readline');\nconst rl = readline.createInterface({\n    input: process.stdin,\n    output: process.stdout\n});\n\n",
                placeHolderCode: 'var isValid = function(s) {\n\n};',
                afterCode:
    ...
    },
    {
        ...
        driverCodes: [
            ...
            },
            {
                language: 'C',
                beforeCode: '#include <stdio.h>\n\n',
                placeHolderCode: 'void reverseString(char* s, int sSize) {\n\n}',
                afterCode:
            ...
            },
            {
                ...
                beforeCode:
                    "const readline = require('readline');\nconst rl = readline.createInterface({\n    input: process.stdin,\n    output: process.stdout\n});\n\n",
                placeHolderCode: 'var reverseString = function(s) {\n\n};',
                afterCode:
    ...
    },
    {
        ...
        driverCodes: [
            ...
            },
            {
                language: 'C',
                beforeCode: '#include <stdio.h>\n#include <limits.h>\n\n',
                placeHolderCode: 'int maxSubArray(int* nums, int numsSize) {\n\n}',
                afterCode:
            ...
            },
            {
                ...
                beforeCode:
                    "const readline = require('readline');\nconst rl = readline.createInterface({\n    input: process.stdin,\n    output: process.stdout\n});\n\n",
                placeHolderCode: 'var maxSubArray = function(nums) {\n\n};',
                afterCode:
    ...
    },
    {
        ...
        driverCodes: [
            ...
            },
            {
                language: 'C',
                beforeCode: '#include <stdio.h>\n#include <string.h>\n\n',
                placeHolderCode: 'int lengthOfLongestSubstring(char* s) {\n\n}',
                afterCode:
            ...
            },
            {
                ...
                beforeCode:
                    "const readline = require('readline');\nconst rl = readline.createInterface({\n    input: process.stdin,\n    output: process.stdout\n});\n\n",
                placeHolderCode: 'var lengthOfLongestSubstring = function(s) {\n\n};',
                afterCode:
    ...
    },
    {
        ...
        driverCodes: [
            ...
            },
            {
                ...
                placeHolderCode: 'var inorderTraversal = function(root) {\n\n};',
                afterCode:
